...
//widget for success/fail message screens.
      ...
      body: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                title, style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.black),
              ),
              //const SizedBox(height: 24,),
              Text(
                message, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400, color: Colors.black),
              ),
