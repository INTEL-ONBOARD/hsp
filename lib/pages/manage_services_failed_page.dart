...
class ManageServicesFailedPage extends StatelessWidget {
  const ManageServicesFailedPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //widget for managing a service failed screen(implementation is around line ~64)
      body: const SuccessScreen(
        title: "Failed!",
        imagePath: "lib/assets/failed-x.png",
